...
<p align="center">
  ...
  <a href="#-实测展示"><img src="https://img.shields.io/badge/Demo-8_款软件-green?style=for-the-badge" alt="Demos"></a>
  <a href="#-测试结果"><img src="https://img.shields.io/badge/测试-1%2C298_通过-brightgreen?style=for-the-badge" alt="Tests"></a>
...
| ⚡ "原型和生产之间差十万八千里" | 1,298+ 测试用例，全部在真实软件上验证通过，覆盖 8 款主流应用 |
...
### 🏭 专业级测试
在 8 款复杂的开源应用上进行了实测，涵盖创意和生产力领域 —— 这些软件此前对 AI Agent 来说几乎不可触及。
...
> 全部 1,298 项测试 **100% 通过** —— 895 项单元测试 + 403 项端到端测试。
...
这本手册提炼了成功构建全部 8 套生产级 CLI 的关键经验。
...
<sub>为 AI Agent 时代而生 | 8 款专业软件实测 | 1,298 项测试全部通过</sub>
